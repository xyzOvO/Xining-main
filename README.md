...
<project xmlns="http://maven.apache.org/POM/4.0.0"
    ...
    <modules>
        <module>xyz66-framework</module>
        <module>xyz66-admin</module>
        <module>xyz66-forum</module>
    </modules>
            ...
            <plugin>
                ...
                <configuration>
                    <archive>
                        <manifest>
                            <!-- 配置程序运行入口所在的类 -->
                            <mainClass>com.xyz66.XiningAdminApplication</mainClass>
                        </manifest>
                        <manifest>
                            <!-- 配置程序运行入口所在的类 -->
                            <mainClass>com.xyz66.XiningForumApplication</mainClass>
                        </manifest>
                    </archive>
                    <!-- 设置 JAR 包输出目录 -->
