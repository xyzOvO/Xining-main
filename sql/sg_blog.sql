...
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '文章表' ROW_FORMAT = Compact;
...
INSERT INTO `sg_article` VALUES (10, '雪豹测试', '测试', '雪豹测试', 7, '', '1', '0', 0, '0', 1, '2023-12-11 09:37:57', NULL, '2023-12-11 09:38:25', 0);
INSERT INTO `sg_article` VALUES (11, '兔狲测试', '兔狲测试', '兔狲测试', 8, '', '1', '0', 0, '0', 1, '2023-12-11 09:38:43', 1, '2023-12-11 09:38:43', 0);
INSERT INTO `sg_article` VALUES (12, '荒漠猫测试', '荒漠猫测试', '荒漠猫测试', 9, '', '1', '0', 0, '0', 1, '2023-12-11 09:38:55', 1, '2023-12-11 09:38:55', 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '文章标签关联表' ROW_FORMAT = Compact;
...
CREATE TABLE `sg_comment`  (
  ...
  `del_flag` int(1) NULL DEFAULT 0 COMMENT '删除标志（0代表未删除，1代表已删除）',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 41 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '评论表' ROW_FORMAT = Compact;
...
CREATE TABLE `sg_tag`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '标签' ROW_FORMAT = Compact;
