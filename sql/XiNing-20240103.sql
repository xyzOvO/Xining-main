...
-- ----------------------------
INSERT INTO `c_message` VALUES ('d44ee51e44764d41ba1cf334ed3e0af3');
INSERT INTO `c_message` VALUES ('11111111111111');
...
) ENGINE = InnoDB AUTO_INCREMENT = 23 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '文章表' ROW_FORMAT = Compact;
...
INSERT INTO `sg_article` VALUES (10, '雪豹测试', '测试', '雪豹测试', 7, '', '1', '0', 14, '0', 1, '2023-12-11 09:37:57', NULL, '2023-12-11 09:38:25', 0);
INSERT INTO `sg_article` VALUES (11, '兔狲测试', '兔狲测试', '兔狲测试', 8, '', '1', '0', 0, '0', 1, '2023-12-11 09:38:43', 1, '2023-12-11 09:38:43', 0);
INSERT INTO `sg_article` VALUES (12, '荒漠猫测试', '荒漠猫测试', '荒漠猫测试', 9, '', '1', '0', 8, '0', 1, '2023-12-11 09:38:55', 1, '2023-12-11 09:38:55', 0);
INSERT INTO `sg_article` VALUES (22, '测试', '测试', '测试', 7, '', '1', '0', 1, '0', 1, '2023-12-27 09:17:58', 1, '2023-12-27 09:17:58', 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 23 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '文章标签关联表' ROW_FORMAT = Compact;
...
INSERT INTO `sg_article_tag` VALUES (22, 6);
...
CREATE TABLE `sg_category`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '分类表' ROW_FORMAT = Compact;
...
CREATE TABLE `sg_comment`  (
  ...
  `del_flag` int(1) NULL DEFAULT 0 COMMENT '删除标志（0代表未删除，1代表已删除）',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 45 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '评论表' ROW_FORMAT = Compact;
...
INSERT INTO `sg_comment` VALUES (40, '0', 10, -1, '测试测试', -1, -1, 1, '2023-12-27 07:19:36', 1, '2023-12-27 07:19:36', 0);
INSERT INTO `sg_comment` VALUES (41, '0', 10, 40, '测试测试测试', 1, 40, 1, '2023-12-27 07:19:44', 1, '2023-12-27 07:19:44', 0);
INSERT INTO `sg_comment` VALUES (42, '0', 10, -1, '测试', -1, -1, 1, '2023-12-27 08:04:01', 1, '2023-12-27 08:04:01', 0);
INSERT INTO `sg_comment` VALUES (43, '0', 10, 42, '你好！', 1, 42, 1, '2023-12-27 08:04:14', 1, '2023-12-27 08:04:14', 0);
INSERT INTO `sg_comment` VALUES (44, '1', 1, -1, '友链测试', -1, -1, 1, '2024-01-03 01:48:09', 1, '2024-01-03 01:48:09', 0);
...
CREATE TABLE `sg_tag`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '标签' ROW_FORMAT = Compact;
...
INSERT INTO `sg_tag` VALUES (7, '标签测试', 1, '2023-12-27 09:14:00', 1, '2023-12-27 09:14:00', 0, '测试');
...
INSERT INTO `sys_menu` VALUES (2023, '写文章', 0, 0, 'write', 'content/article/write/index', 1, 'C', '0', '0', 'content:article:writer', 'build', NULL, '2022-01-08 03:39:58', 1, '2022-07-31 22:07:05', '', '0');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'xyz', 'Xyz66', '$2a$10$Jnq31rRkNV3RNzXe0REsEOSKaYK8UgVZZqlNlNXqn.JeVcj2NdeZy', '1', '0', '2910223554@qq.com', '18888888888', '1', 'http://rxbyapge1.hn-bkt.clouddn.com/2023/07/11/a57dbebeb43449e9bd2d4879faeb3437.png', NULL, '2022-01-21 14:58:30', 1, '2022-01-21 14:58:30', 0);
INSERT INTO `sys_user` VALUES (3, 'sg3', 'weqe', '$2a$10$ydv3rLkteFnRx9xelQ7elOiVhFvXOooA98xCqk/omh7G94R.K/E3O', '1', '0', NULL, NULL, '0', NULL, NULL, '2022-01-21 14:58:30', NULL, '2022-01-21 14:58:30', 0);
INSERT INTO `sys_user` VALUES (5, 'sg2233', 'tteqe', '', '1', '0', NULL, '18246845873', '1', NULL, NULL, '2022-01-21 14:58:30', NULL, '2022-01-21 14:58:30', 0);
INSERT INTO `sys_user` VALUES (6, 'sangeng', 'sangeng', '$2a$10$Jnq31rRkNV3RNzXe0REsEOSKaYK8UgVZZqlNlNXqn.JeVcj2NdeZy', '1', '0', '2312321', '17777777777', '0', NULL, NULL, '2022-01-21 14:58:30', NULL, '2022-01-21 14:58:30', 0);
INSERT INTO `sys_user` VALUES (14787164048662, 'weixin', 'weixin', '$2a$10$y3k3fnMZsBNihsVLXWfI8uMNueVXBI08k.LzWYaKsW8CW7xXy18wC', '0', '0', 'weixin@qq.com', NULL, NULL, NULL, -1, '2022-01-21 14:58:30', -1, '2022-01-21 14:58:30', 0);
INSERT INTO `sys_user` VALUES (14787164048663, 'xyz123', '测试昵称', '$2a$10$R6DUNeyCvYe/iCdYciZCuOoTVI/fD7jTz3sIFnEqN4DC1qtv0IbbG', '0', '0', '2910223554@qq.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0);
INSERT INTO `sys_user` VALUES (14787164048664, 'xyz1233', '测试昵称1', '$2a$10$rsAyXv2OJ.aoVTq1/E5XqOeBvj0vY64ldr0.Fu0zfFRtw/iCMmI6y', '0', '0', '2910223554@qq.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0);
